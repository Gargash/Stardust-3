...
function v3fxConvoHandler:getInitialScreen(pPlayer, pNpc, pConvTemplate)
	...
	if (ghost:getPilotTier() >= 4) then
		VortexSquadronScreenplay:migrateTier4Quests(pPlayer)

		local t4QuestOneStarted = VortexSquadronScreenplay:isTier4MissionActive(pPlayer, 1)
		local t4QuestTwoStarted = VortexSquadronScreenplay:isTier4MissionActive(pPlayer, 2)
		local t4QuestThreeStarted = VortexSquadronScreenplay:isTier4MissionActive(pPlayer, 3)
		local t4QuestFourStarted = VortexSquadronScreenplay:isTier4MissionActive(pPlayer, 4)

		local t4QuestOneComplete = VortexSquadronScreenplay:isTier4MissionComplete(pPlayer, 1)
		local t4QuestTwoComplete = VortexSquadronScreenplay:isTier4MissionComplete(pPlayer, 2)
		local t4QuestThreeComplete = VortexSquadronScreenplay:isTier4MissionComplete(pPlayer, 3)
		local t4QuestFourComplete = VortexSquadronScreenplay:isTier4MissionComplete(pPlayer, 4)

		local t4Duty1Started = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.name)
		local t4Duty2Started = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.name)
		local t4Duty3Started = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.name)
		local t4Duty4Started = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.name)

		local t4Duty1Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_1.name)
		local t4Duty2Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_2.name)
		local t4Duty3Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_3.name)
		local t4Duty4Complete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_DUTY_4.name)

		local masterStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_MASTER.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_MASTER.name) or
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER4_QUEST_STRING_MASTER_2.type, VortexSquadronScreenplay.TIER4_QUEST_STRING_MASTER_2.name)
		...
		-- Reward Checks
		elseif (t4QuestFourComplete and getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_4.name .. ":reward") ~= "1") then
			return convoTemplate:getScreen("tier4_fourth_mission_success")
		elseif (t4QuestThreeComplete and getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_3.name .. ":reward") ~= "1") then
			return convoTemplate:getScreen("tier4_third_mission_success")
		elseif (t4QuestTwoComplete and getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_2.name .. ":reward") ~= "1") then
		...
		elseif (getQuestStatus(playerID .. "VortexSquadronScreenplay:StartedV3fxTier4") ~= "1") then
			setQuestStatus(playerID .. "VortexSquadronScreenplay:StartedV3fxTier4", 1)
		...
		elseif (not t4QuestFourComplete) then
			...
			if (t4QuestThreeComplete and not t4QuestFourStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_4.name .. ":attempted") == "1") then
			...
			elseif (t4QuestTwoComplete and not t4QuestThreeStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_3.name .. ":attempted") == "1") then
			...
			elseif (t4QuestOneComplete and not t4QuestTwoStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER4_QUEST_STRING_2.name .. ":attempted") == "1") then
	...
	if (ghost:getPilotTier() == 3) then
		...
		local t3QuestOneStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_1.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_1.name) or
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE1.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE1.name) or
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE2.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE2.name) or
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE3.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE3.name) or
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE4.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_1_SIDE4.name)
		...
		local t3QuestFourStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_4.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_4.name) or
								...
								SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER3_QUEST_STRING_4_SIDE3.type, VortexSquadronScreenplay.TIER3_QUEST_STRING_4_SIDE3.name) or
		...
		if (not t3QuestFourComplete) then
			...
			if (t3QuestThreeComplete and not t3QuestFourStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER3_QUEST_STRING_4.name .. ":attempted") == "1") then
			...
			elseif (t3QuestTwoComplete and not t3QuestThreeStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER3_QUEST_STRING_3.name .. ":attempted") == "1") then
			...
			elseif (t3QuestOneComplete and not t3QuestTwoStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER3_QUEST_STRING_2.name .. ":attempted") == "1") then
			...
			elseif (not t3QuestOneComplete) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER3_QUEST_STRING_1.name .. ":attempted") == "1") then
	...
	if (ghost:getPilotTier() == 2) then
		...
		local t2QuestOneComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_1.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_1.name)
		local t2QuestTwoComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_2.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_2.name)
		local t2QuestThreeComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_3.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_3.name)
		local t2QuestFourComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_4.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_4.name)

		local t2DestroyDutyStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_1.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_1.name)
		local t2RecoveryDutyStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_2.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_2.name)
		local t2EscortDutyStarted = SpaceHelpers:isSpaceQuestActive(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_3.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_3.name)

		local t2DestroyDutyComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_1.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_1.name)
		local t2RecoveryDutyComplete = SpaceHelpers:isSpaceQuestComplete(pPlayer, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_2.type, VortexSquadronScreenplay.TIER2_QUEST_STRING_DUTY_2.name)
		...
		elseif (not t2QuestFourComplete) then
			...
			if (t2QuestThreeComplete and not t2QuestFourStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER2_QUEST_STRING_4.name .. ":attempted") == "1") then
			...
			elseif (t2QuestTwoComplete and not t2QuestThreeStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER2_QUEST_STRING_3.name .. ":attempted") == "1") then
			...
			elseif (t2QuestOneComplete and not t2QuestTwoStarted) then
				if (getQuestStatus(playerID .. VortexSquadronScreenplay.TIER2_QUEST_STRING_2.name .. ":attempted") == "1") then
		...
		if (getQuestStatus(playerID .. "VortexSquadronScreenplay:tier2_introduced") == "1") then
			return convoTemplate:getScreen("tier2_duty_missions")
		end
...
function v3fxConvoHandler:runScreenHandlers(pConvTemplate, pPlayer, pNpc, selectedOption, pConvScreen)
	...
	if (screenID == "missions_complete") then
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_starships_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_26970ef", "train_player_fighters_free") -- I am interested in basic starfighter training.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_weapons_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_3fa70900", "train_player_component_free") -- I am interested in basic starship component use.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_procedures_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_8c272224", "train_player_basics_free") -- I am interested in starfighter survival tactics.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_droid_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_9480f430", "train_player_droid_free") -- I am interested in droid interface basics.
		end
	...
	elseif (screenID == "more_training") then
		...
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_starships_01") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_starships_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_26970ef", "train_player_fighters") -- I am interested in basic starfighter training.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_weapons_01") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_weapons_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_3fa70900", "train_player_component") -- I am interested in basic starship component use.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_procedures_01") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_procedures_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_8c272224", "train_player_basics") -- I am interested in starfighter survival tactics.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_droid_01") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_droid_01")) then
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_9480f430", "train_player_droid") -- I am interested in droid interface basics.
		end
	...
	elseif (screenID == "yes_i_am" or screenID == "welcome_navy") then
		...
		if (not SpaceHelpers:hasCertifiedShip(pPlayer, true)) then
			...
			clonedConversation:addOption("@conversation/naboo_rebel_trainer_1:s_f0b6493f", "yes_ship") -- Thank you, V3.
		end
	...
	elseif (screenID == "tier2_training_menu") then
		...
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_starships_02") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_starships_02")) then
			clonedConversation:addOption("@conversation/dantooine_rebel_trainer_2:s_c6c91897", "tier2_train_fighters") -- Multi-Role Craft
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_weapons_02") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_weapons_02")) then
			clonedConversation:addOption("@conversation/dantooine_rebel_trainer_2:s_98d991e7", "tier2_train_component") -- Weapons B, Intermediate Alliance Starship Ordnance
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_procedures_02") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_procedures_02")) then
			clonedConversation:addOption("@conversation/dantooine_rebel_trainer_2:s_73ccefde", "tier2_train_basics") -- Intermediate Procedures
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_droid_02") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_droid_02")) then
			clonedConversation:addOption("@conversation/dantooine_rebel_trainer_2:s_3c4ff185", "tier2_train_droid") -- Astromech Management
		end
	...
	elseif (screenID == "tier2_intro_accept") then
		local playerID = CreatureObject(pPlayer):getObjectID()
		setQuestStatus(playerID .. "VortexSquadronScreenplay:tier2_introduced", 1)

	-- Tier 2 Duty Missions
	elseif (screenID == "tier2_destroy_duty") then
		destroy_duty_naboo_rebel_tier2_destroyduty:startQuest(pPlayer, pNpc)
	elseif (screenID == "tier2_recovery_duty") then
		recovery_duty_naboo_rebel_tier2_recoveryduty:startQuest(pPlayer, pNpc)
	elseif (screenID == "tier2_escort_duty") then
		escort_duty_naboo_rebel_tier2_escortduty:startQuest(pPlayer, pNpc)
	...
	elseif (string.find(screenID, "tier3_excellent_work")) then
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_starships_03")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier3:s_879249ea", "tier3_train_fighters") -- Advanced Fighters
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_weapons_03")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier3:s_e6be1367", "tier3_train_component") -- Advanced Weapons
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_procedures_03")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier3:s_a436613b", "tier3_train_basics") -- Advanced Procedures
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_droid_03")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier3:s_ccecab6a", "tier3_train_droid") -- Advanced Droid Interface
		end
	...
	elseif (screenID == "ready_train_tier4") then
		...
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_starships_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_starships_04")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier4:s_f4d84e3", "tier4_train_fighters") -- I am interested in advanced starfighter training.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_weapons_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_weapons_04")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier4:s_d0f87f24", "tier4_train_component") -- I am interested in advanced starship component use.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_procedures_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_procedures_04")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier4:s_dbb3b0b0", "tier4_train_basics") -- I am interested in advanced procedures.
		end
		if (not CreatureObject(pPlayer):hasSkill("pilot_rebel_navy_droid_04") and skillManager:fulfillsSkillPrerequisitesAndXp(pPlayer, "pilot_rebel_navy_droid_04")) then
			clonedConversation:addOption("@conversation/naboo_rebel_tier4:s_71d852f5", "tier4_train_droid") -- I am interested in advanced droid interface training.
		end
	...
	elseif (string.find(screenID, "tier4_train_")) then
		...
		if (SpaceHelpers:hasExperienceForTraining(pPlayer, 4) or
				VortexSquadronScreenplay:isTier4MissionComplete(pPlayer, 4)) then
	...
	elseif (screenID == "tier4_fourth_mission_success") then
		...
		space_battle_naboo_rebel_tier4_4:rewardPlayer(pPlayer)
		PlayerObject(pGhost):increaseFactionStanding("rebel", 165)
	elseif (screenID == "tier4_third_mission_success") then
		...
		rescue_naboo_rebel_tier4_3:rewardPlayer(pPlayer)
		PlayerObject(pGhost):increaseFactionStanding("rebel", 150)
	elseif (screenID == "tier4_second_mission_success") then
		...
		assassinate_naboo_rebel_tier4_2:rewardPlayer(pPlayer)
		PlayerObject(pGhost):increaseFactionStanding("rebel", 150)
	elseif (screenID == "tier4_first_mission_success") then
		...
		survival_naboo_rebel_tier4_1:rewardPlayer(pPlayer)
		PlayerObject(pGhost):increaseFactionStanding("rebel", 165)
	...
	elseif (screenID == "accept_tier4_fourth_mission" or screenID == "failed_tier4_fourth_mission") then
		...
		VortexSquadronScreenplay:migrateTier4Quests(pPlayer)
		VortexSquadronScreenplay:prepareTier4MissionAttempt(pPlayer, 4)
		space_battle_naboo_rebel_tier4_4:startQuest(pPlayer, pNpc)
	elseif (screenID == "accept_tier4_third_mission" or screenID == "failed_tier4_third_mission") then
		...
		VortexSquadronScreenplay:migrateTier4Quests(pPlayer)
		VortexSquadronScreenplay:prepareTier4MissionAttempt(pPlayer, 3)
		rescue_naboo_rebel_tier4_3:startQuest(pPlayer, pNpc)
	elseif (screenID == "accept_tier4_second_mission" or screenID == "failed_tier4_second_mission") then
		...
		VortexSquadronScreenplay:migrateTier4Quests(pPlayer)
		VortexSquadronScreenplay:prepareTier4MissionAttempt(pPlayer, 2)
	...
	elseif (screenID == "accept_tier4_first_mission" or screenID == "failed_tier4_first_mission") then
		...
		VortexSquadronScreenplay:migrateTier4Quests(pPlayer)
		VortexSquadronScreenplay:prepareTier4MissionAttempt(pPlayer, 1)
