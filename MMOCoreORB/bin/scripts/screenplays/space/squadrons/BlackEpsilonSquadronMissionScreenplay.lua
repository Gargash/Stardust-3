...
blackEpsilonMission("assassinate_corellia_imperial_tier3_4_a", SpaceAssassinateScreenplay, chain({
	questName = "corellia_imperial_tier3_4_a", questType = "assassinate", questZone = lok, arrivalDelay = 5, assassinateSpawns = {target = "nym_patrol_vessel_checkpoint_tier4", escorts = {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_arc170_enforcer_tier3", "nym_arc170_enforcer_tier3", "nym_arc170_enforcer_tier3"}}, targetPatrols = {{patrolPointName = "black_epsilon_t3_4_patrol_craft", zoneName = lok, x = 1000, z = 1200, y = -4900}},
...
blackEpsilonMission("assassinate_corellia_imperial_tier3_4_c", SpaceAssassinateScreenplay, chain({
	questName = "corellia_imperial_tier3_4_c", questType = "assassinate", questZone = lok, arrivalDelay = 5, assassinateSpawns = {target = "nym_karthakk_queen_tier4", escorts = {"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3"}}, targetPatrols = {{patrolPointName = "black_epsilon_t3_4_queen", zoneName = lok, x = 5200, z = -900, y = 3800}},
