...
blackEpsilonMission("escort_corellia_imperial_tier3_2_b", SpaceEscortScreenplay, chain({
	questName = "corellia_imperial_tier3_2_b", questType = "escort", questZone = yavin, escortSpeed = 45, orderedEscortRoute = true, escortShips = {"imp_huttsmuggler_tier3"}, escortPoints = {{patrolPointName = "black_epsilon_t3_2_b_1", zoneName = yavin, x = -3200, z = -1000, y = 2500, escortNumber = 1, radius = 250}, {patrolPointName = "black_epsilon_t3_2_b_2", zoneName = yavin, x = -900, z = 100, y = 300, escortNumber = 2, radius = 250}, {patrolPointName = "black_epsilon_t3_2_b_3", zoneName = yavin, x = 2800, z = -600, y = -2200, escortNumber = 3, radius = 250}}, attackDelay = 20, attackShips = {{"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_enforcer_captain_tier4"}, {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_enforcer_captain_tier4"}},
...
blackEpsilonMission("space_battle_corellia_imperial_tier3_2_c", SpaceBattleScreenplay, chain({
	questName = "corellia_imperial_tier3_2_c", questType = "space_battle", questZone = yavin, battleLocation = {x = 3900, z = 500, y = 3600}, allyArrivalDelay = 10, enemyArrivalDelay = 15, allyOriginDist = -700, enemyOriginDist = 900, allyArrivalDist = -100, enemyArrivalDist = 0, alliedShips = {{"hutt_fighter_s01_tier4"}, {"hutt_fighter_s01_tier4"}, {"hutt_fighter_s01_tier4"}, {"hutt_fighter_s01_tier4"}}, enemyShips = {{"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_xwing_enforcer_tier4"}, {"nym_enforcer_captain_tier4"}},
...
blackEpsilonMission("rescue_corellia_imperial_tier3_3", SpaceRescueScreenplay, chain({
	questName = "corellia_imperial_tier3_3", questType = "rescue", questZone = yavin, creditReward = 25000, arrivalDelay = 5, rescueShip = "imp_freightermedium_tier3", rescueLocation = {x = -4900, z = 900, y = -3600}, repairDelay = 20, escortSpeed = 45, escortPoints = {{patrolPointName = "black_epsilon_t3_3_escape", zoneName = yavin, x = -1800, z = 200, y = -900, escortNumber = 1, radius = 250}}, escortAttackDelay = 15, escortAttackShips = {{{count = 1, shipName = "nym_bomber_tier3"}, {count = 3, shipName = "nym_xwing_enforcer_tier3"}, {count = 1, shipName = "nym_enforcer_captain_tier4"}}, {{count = 4, shipName = "reb_awing_tier3"}, {count = 1, shipName = "reb_bwing_tier3"}, {count = 1, shipName = "reb_z95_tier3"}}},
...
blackEpsilonMission("assassinate_corellia_imperial_tier3_3_a", SpaceAssassinateScreenplay, chain({
	questName = "corellia_imperial_tier3_3_a", questType = "assassinate", questZone = yavin, arrivalDelay = 5, assassinateSpawns = {target = "reb_emissary_tier4", escorts = {"reb_awing_tier3", "reb_awing_tier3", "reb_awing_tier3", "reb_xwing_tier3", "reb_xwing_tier3", "reb_xwing_tier3", "reb_bwing_tier3"}}, targetPatrols = {{patrolPointName = "black_epsilon_t3_3_emissary", zoneName = yavin, x = 3800, z = 1400, y = 4600}},
...
blackEpsilonMission("assassinate_corellia_imperial_tier3_4_a", SpaceAssassinateScreenplay, chain({
	questName = "corellia_imperial_tier3_4_a", questType = "assassinate", questZone = lok, arrivalDelay = 5, assassinateSpawns = {target = "nym_patrol_vessel_checkpoint_tier4", escorts = {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3"}}, targetPatrols = {{patrolPointName = "black_epsilon_t3_4_patrol_craft", zoneName = lok, x = 1000, z = 1200, y = -4900}},
...
blackEpsilonMission("survival_corellia_imperial_tier3_4_b", SpaceSurvivalScreenplay, chain({
	questName = "corellia_imperial_tier3_4_b", questType = "survival", questZone = lok, survivalTime = 600, survivalUpdateInterval = 60, survivalPoint = {x = 3300, z = 200, y = -500}, survivalAreaRadius = 500, attackDelay = 30, attackShips = {{"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier4"}, {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_fighter_tier4"}, {"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier4"}, {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_fighter_tier4"}, {"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier4"}},
