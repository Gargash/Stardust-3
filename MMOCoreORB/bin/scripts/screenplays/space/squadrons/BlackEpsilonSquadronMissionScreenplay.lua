...
blackEpsilonMission("recovery_corellia_imperial_tier3_2", SpaceRecoveryScreenplay, chain({
	questName = "corellia_imperial_tier3_2", questType = "recovery", questZone = yavin, creditReward = 25000, arrivalDelay = 5, recoveryDelay = 20, escortSpeed = 45, recoverShip = "nym_freightermedium_tier3", recoveryConversationMobile = "object/mobile/dressed_imperial_officer_m.iff", escortShips = {"nym_fighter_tier3", "nym_fighter_tier3"}, preRecoveryPoints = {{patrolPointName = "black_epsilon_t3_2_capture", zoneName = yavin, x = -4400, z = -700, y = 3300, escortNumber = 1, radius = 250}}, recoveryPoints = {{patrolPointName = "black_epsilon_t3_2_escape", zoneName = yavin, x = -1800, z = -200, y = 900, escortNumber = 1, radius = 250}}, attackDelay = 15, attackShips = {{"nym_fighter_tier3"}},
