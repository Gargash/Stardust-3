...
blackEpsilonMission("survival_corellia_imperial_tier3_2_a", SpaceSurvivalScreenplay, chain({
	questName = "corellia_imperial_tier3_2_a", questType = "survival", questZone = yavin, survivalTime = 600, survivalUpdateInterval = 60, survivalPoint = {x = -3600, z = 700, y = 3900}, survivalAreaRadius = 500, attackDelay = 30, attackShips = {{"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_blastboat_tier3", "nym_blastboat_tier3"}, {"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier4"}, {"nym_xwing_enforcer_tier3", "nym_xwing_enforcer_tier3", "nym_blastboat_tier3", "nym_blastboat_tier3"}, {"nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier3", "nym_fighter_tier4"}},
