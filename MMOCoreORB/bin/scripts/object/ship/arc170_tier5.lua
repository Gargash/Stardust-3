...
object_ship_arc170_tier5 = object_ship_shared_arc170_tier5:new {
	objectName = "@space/space_mobile_type:arc170_tier5",
...
ObjectTemplates:addTemplate(object_ship_arc170_tier5, "object/ship/arc170_tier5.iff")
